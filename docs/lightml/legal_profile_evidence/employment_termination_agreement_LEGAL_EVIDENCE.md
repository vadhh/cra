# Legal Profile Evidence: Employment Termination Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/employment_termination_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A employment termination agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: UU 13/2003 severance pay rules apply.)
...
- **Evidence Status**: Repository Verified
### Clause: entire_agreement
- **Clause**: entire_agreement
- **Reason Mandatory**: Supersedes prior negotiations and informal agreements.
- **Repository Source**: ldv-backend/detector/profiles/employment_termination_agreement.json
- **Legal Reference**: KUH Perdata (Indonesian Civil Code) Article Pasal 1320, Pasal 1338 (ID)
- **Evidence Status**: Repository Verified
...
- **Evidence Status**: Repository Verified
### Clause Mapping: entire_agreement
- **Law / Code**: KUH Perdata (Indonesian Civil Code)
- **Article**: Pasal 1320, Pasal 1338
- **Official Citation / Note**: Keseluruhan Perjanjian tertulis.
- **Repository Mapping**: Mapped to clause 'entire_agreement' in ldv-backend/detector/detector_rules.py
- **Evidence Status**: Repository Verified
...
- **Verified Repository Alias**: employment termination agreement, separation agreement, termination agreement, perjanjian pemutusan hubungan kerja, phk, perjanjian phk
- **Draft Alias**: employment termination agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: employment termination agreement, separation agreement, termination agreement, phk
- **Indonesian**: perjanjian pemutusan hubungan kerja, perjanjian phk
...
- **Competing Profiles**: employment_contract
...
- **How They Differ**: Employment Termination Agreement governs specific legal relations defined in employment_termination_agreement.json and registry_v1.json, distinct from generic terms in employment_contract.
...
- **Disambiguation Criteria**: This document is an employment termination or separation agreement setting the terms on which an employment relationship ends. (distinction from employment_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, compensation, termination, dispute_resolution, entire_agreement) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Employment Termination Agreement (employment_agreements)
- **Evidence Status**: Repository Verified
