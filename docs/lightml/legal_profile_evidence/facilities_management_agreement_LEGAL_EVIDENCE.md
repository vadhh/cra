# Legal Profile Evidence: Facilities Management Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/facilities_management_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A facilities management agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: facilities management agreement, fm agreement, perjanjian manajemen fasilitas
- **Draft Alias**: facilities management agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: facilities management agreement, fm agreement
- **Indonesian**: perjanjian manajemen fasilitas
...
- **How They Differ**: Facilities Management Agreement governs specific legal relations defined in facilities_management_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a facilities management agreement for the operation and maintenance of a building or site's facilities. (distinction from general_contract).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Facilities Management Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
