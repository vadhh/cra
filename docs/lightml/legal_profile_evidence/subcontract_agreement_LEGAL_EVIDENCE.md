# Legal Profile Evidence: Subcontract Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/subcontract_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A subcontract agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: subcontract agreement, subcontractor agreement, perjanjian subkontraktor
- **Draft Alias**: subcontract agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: subcontract agreement, subcontractor agreement
- **Indonesian**: perjanjian subkontraktor
...
- **How They Differ**: Subcontract Agreement governs specific legal relations defined in subcontract_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a subcontract agreement in which a subcontractor performs part of a main contractor's obligations. (distinction from general_contract).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Subcontract Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
