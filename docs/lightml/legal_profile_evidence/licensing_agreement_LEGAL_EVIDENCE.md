# Legal Profile Evidence: Licensing Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/licensing_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A licensing agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: licensing agreement, license agreement, perjanjian lisensi, contrat de licence
- **Draft Alias**: licensing agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: licensing agreement, license agreement, contrat de licence
- **Indonesian**: perjanjian lisensi
...
- **How They Differ**: Licensing Agreement governs specific legal relations defined in licensing_agreement.json and registry_v1.json, distinct from generic terms in software_license.
...
- **Disambiguation Criteria**: This document is a licensing agreement granting rights to use intellectual property in exchange for royalties or fees. (distinction from software_license).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Licensing Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
