# Legal Profile Evidence: Cooperation Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/cooperation_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A cooperation agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: cooperation agreement, collaboration agreement, perjanjian kerjasama, perjanjian kolaborasi, accord de coopération, samenwerkingsovereenkomst
- **Draft Alias**: cooperation agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: cooperation agreement, collaboration agreement, accord de coopération, samenwerkingsovereenkomst
- **Indonesian**: perjanjian kerjasama, perjanjian kolaborasi
...
- **Competing Profiles**: partnership_agreement
...
- **How They Differ**: Cooperation Agreement governs specific legal relations defined in cooperation_agreement.json and registry_v1.json, distinct from generic terms in partnership_agreement.
...
- **Disambiguation Criteria**: This document is a cooperation agreement establishing a framework for collaboration between parties without forming a joint venture. (distinction from partnership_agreement).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Cooperation Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
