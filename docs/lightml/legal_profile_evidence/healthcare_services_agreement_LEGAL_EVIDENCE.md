# Legal Profile Evidence: Healthcare Services Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/healthcare_services_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A healthcare services agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: UU 36/2009 Kesehatan applies for ID.)
...
- **Verified Repository Alias**: healthcare services agreement, medical services agreement, perjanjian layanan kesehatan
- **Draft Alias**: healthcare services agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: healthcare services agreement, medical services agreement
- **Indonesian**: perjanjian layanan kesehatan
...
- **How They Differ**: Healthcare Services Agreement governs specific legal relations defined in healthcare_services_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a healthcare services agreement for the provision of medical or clinical services. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, confidentiality, indemnification, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Healthcare Services Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
