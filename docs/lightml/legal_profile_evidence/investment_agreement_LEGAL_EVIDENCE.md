# Legal Profile Evidence: Investment Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/investment_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A investment agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: investment agreement, subscription agreement, perjanjian investasi, contrat d'investissement
- **Draft Alias**: investment agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: investment agreement, subscription agreement, contrat d'investissement
- **Indonesian**: perjanjian investasi
...
- **How They Differ**: Investment Agreement governs specific legal relations defined in investment_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an investment agreement setting the terms under which an investor provides capital in exchange for equity or returns. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, principal_amount, profit_sharing, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Investment Agreement (corporate_agreements)
- **Evidence Status**: Repository Verified
