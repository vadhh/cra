# Legal Profile Evidence: Banking Facility Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/banking_facility_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A banking facility agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: OJK Peraturan applies for ID.)
...
- **Verified Repository Alias**: banking facility agreement, credit facility agreement, perjanjian fasilitas kredit, perjanjian pinjaman bank
- **Draft Alias**: banking facility agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: banking facility agreement, credit facility agreement
- **Indonesian**: perjanjian fasilitas kredit, perjanjian pinjaman bank
...
- **Competing Profiles**: loan_agreement
...
- **How They Differ**: Banking Facility Agreement governs specific legal relations defined in banking_facility_agreement.json and registry_v1.json, distinct from generic terms in loan_agreement.
...
- **Disambiguation Criteria**: This document is a banking facility agreement under which a bank provides a credit facility to a borrower. (distinction from loan_agreement).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Banking Facility Agreement (corporate_agreements)
- **Evidence Status**: Repository Verified
