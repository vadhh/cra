# Legal Profile Evidence: Supply Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/supply_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A supply agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: supply agreement, supplier agreement, procurement agreement, perjanjian pengadaan, perjanjian pasokan
- **Draft Alias**: supply agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: supply agreement, supplier agreement, procurement agreement
- **Indonesian**: perjanjian pengadaan, perjanjian pasokan
...
- **Competing Profiles**: purchase_agreement
...
- **How They Differ**: Supply Agreement governs specific legal relations defined in supply_agreement.json and registry_v1.json, distinct from generic terms in purchase_agreement.
...
- **Disambiguation Criteria**: This document is a supply agreement for the ongoing delivery of goods from a supplier to a buyer. (distinction from purchase_agreement).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, goods_description, payment_terms, delivery_terms, warranty, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Supply Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
