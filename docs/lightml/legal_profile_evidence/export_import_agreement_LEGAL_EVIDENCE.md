# Legal Profile Evidence: Export / Import Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/export_import_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A export / import agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: Incoterms 2020 should be specified.)
...
- **Verified Repository Alias**: export agreement, import agreement, export import agreement, perjanjian ekspor impor
- **Draft Alias**: export / import agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: export agreement, import agreement, export import agreement
- **Indonesian**: perjanjian ekspor impor
...
- **How They Differ**: Export / Import Agreement governs specific legal relations defined in export_import_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an export or import agreement for the cross-border sale and shipment of goods. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, goods_description, payment_terms, delivery_terms, title_transfer, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Export / Import Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
