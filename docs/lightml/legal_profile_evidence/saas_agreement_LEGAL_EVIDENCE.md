# Legal Profile Evidence: SaaS Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/saas_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A saas agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: Per ALIAS_REVIEW.md: canonical assignment for 'saas agreement' moved off software_license onto its own profile; promoted from the legacy detector/profiles/saas_agreement.json content 2026-07-24.)
...
- **Evidence Status**: Repository Verified
### Clause: license_grant
- **Clause**: license_grant
- **Reason Mandatory**: Grants rights to use intellectual property or software.
- **Repository Source**: ldv-backend/detector/profiles/saas_agreement.json
- **Legal Reference**: UU Hak Cipta Article Pasal 80, UU No. 28 Tahun 2014 (ID)
- **Evidence Status**: Repository Verified
### Clause: ip_ownership
- **Clause**: ip_ownership
...
- **Repository Source**: ldv-backend/detector/profiles/saas_agreement.json
- **Legal Reference**: KUH Perdata (Indonesian Civil Code) Article Pasal 1243, Pasal 1365 (ID)
- **Evidence Status**: Repository Verified
### Clause: warranty_disclaimer
- **Clause**: warranty_disclaimer
- **Reason Mandatory**: Limits explicit or implied legal warranties.
- **Repository Source**: ldv-backend/detector/profiles/saas_agreement.json
- **Legal Reference**: KUH Perdata (Indonesian Civil Code) Article Pasal 1491, Pasal 1506 (ID)
- **Evidence Status**: Repository Verified
### Clause: termination
- **Clause**: termination
...
- **Evidence Status**: Repository Verified
### Clause Mapping: license_grant
- **Law / Code**: UU Hak Cipta
- **Article**: Pasal 80, UU No. 28 Tahun 2014
- **Official Citation / Note**: Pemberian lisensi pemanfaatan ciptaan.
- **Repository Mapping**: Mapped to clause 'license_grant' in ldv-backend/detector/detector_rules.py
- **Evidence Status**: Repository Verified
...
- **Evidence Status**: Repository Verified
### Clause Mapping: warranty_disclaimer
- **Law / Code**: KUH Perdata (Indonesian Civil Code)
- **Article**: Pasal 1491, Pasal 1506
- **Official Citation / Note**: Pelepasan garansi dan jaminan tersembunyi.
- **Repository Mapping**: Mapped to clause 'warranty_disclaimer' in ldv-backend/detector/detector_rules.py
- **Evidence Status**: Repository Verified
...
- **Verified Repository Alias**: saas agreement, software as a service agreement, cloud service agreement, layanan awan, berlangganan perangkat lunak
- **Draft Alias**: saas agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: saas agreement, software as a service agreement, cloud service agreement, layanan awan, berlangganan perangkat lunak
- **Indonesian**: perjanjian saas agreement
...
- **Competing Profiles**: software_license
...
- **How They Differ**: SaaS Agreement governs specific legal relations defined in saas_agreement.json and registry_v1.json, distinct from generic terms in software_license.
...
- **Disambiguation Criteria**: This document involves software-as-a-service (SaaS) subscriptions and cloud service terms. (distinction from software_license).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, payment_terms, license_grant, ip_ownership, limitation_liability, warranty_disclaimer, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for SaaS Agreement (baseline_agreements)
- **Evidence Status**: Repository Verified
