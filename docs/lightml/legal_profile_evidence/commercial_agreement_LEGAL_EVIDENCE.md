...
- **Repository Source**: ldv-backend/detector/profiles/commercial_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A commercial agreement is a business-to-business contract defining trade, supply, or operational terms under which commercial entities execute commercial transactions.
...
- **Verified Repository Alias**: commercial agreement, business agreement, trade agreement
- **Draft Alias**: commercial contract, perjanjian komersial
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: commercial contract, commercial agreement, business agreement, trade agreement
...
- **Why They Compete**: Overlap in business-to-business transactions and general supply chain arrangements.
- **How They Differ**: A commercial agreement is a B2B contract governing commercial relations (like distribution or ongoing supply). It is narrower than a general contract (no specific commercial context) but broader than purchase agreements (tangible goods transfer) or service agreements (pure labor execution).
- **Classifier Distinction Strategy**: Analyze whether the transaction involves a broader commercial or strategic partnership rather than a simple transaction of goods or services.
...
- **Disambiguation Criteria**: A commercial agreement is a B2B contract governing commercial relations (like distribution or ongoing supply). It is narrower than a general contract (no specific commercial context) but broader than purchase agreements (tangible goods transfer) or service agreements (pure labor execution). (commercial and legal separation from competing profiles: general_contract, purchase_agreement, service_agreement).
