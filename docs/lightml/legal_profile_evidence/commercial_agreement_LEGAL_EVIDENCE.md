# Legal Profile Evidence: Commercial Agreement

## 1. Contract Definition
- **Formal Legal Definition**: Standard Commercial Agreement profile mapping required clauses.
- **Repository Source**: [profiles/commercial_agreement.json](file:///mnt/c/Users/ADVAN/cra/ldv-backend/detector/profiles/commercial_agreement.json)
...
- **Repository Evidence**: Listed in profiles/commercial_agreement.json required_clauses
...
- **Reason**: Supported jurisdiction for contract analysis profile 'Commercial Agreement'.
- **Repository Source**: profiles/commercial_agreement.json coverage.jurisdictions
...
## 7. Aliases
- **Verified Aliases**: commercial agreement, business agreement, trade agreement
- **Repository Aliases**: trade agreement, commercial agreement, commercial contract, perjanjian komersial, business agreement
- **Draft Aliases**: commercial contract, perjanjian komersial
- **Unsupported Aliases**: Evidence Not Found

### Language Breakdown
- **English**: trade agreement, commercial agreement, commercial contract, business agreement
- **Indonesian**: perjanjian komersial
- **French**: Evidence Not Found
- **Dutch**: Evidence Not Found

## 8. Competing Contract Types
- **Competing Profiles**: general_contract, purchase_agreement, service_agreement
- **Why They Compete**: Broad commercial terms overlap with general contracts or purchase/service arrangements.
- **How They Differ**: Commercial agreement covers trade, business operations, and supply terms between businesses, broader than purchase/service agreements but narrower than general contracts.
- **Classifier Distinction Strategy**: Identify general commercial covenants, payment terms, and business-to-business clauses.

## 9. Disambiguation Criteria
- **Disambiguation Criteria**: Commercial agreement covers trade, business operations, and supply terms between businesses, broader than purchase/service agreements but narrower than general contracts. (commercial and legal separation from competing profiles: general_contract, purchase_agreement, service_agreement).
