# Legal Profile Evidence: Data Processing Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/data_processing_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A data processing agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: GDPR Art. 28 compliance.)
...
- **Verified Repository Alias**: data processing agreement, dpa, data processing addendum, perjanjian pemrosesan data
- **Draft Alias**: data processing agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: data processing agreement, dpa, data processing addendum
- **Indonesian**: perjanjian pemrosesan data
...
- **How They Differ**: Data Processing Agreement governs specific legal relations defined in data_processing_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a data processing agreement governing how a processor handles personal data on behalf of a controller. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, confidentiality, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Data Processing Agreement (corporate_agreements)
- **Evidence Status**: Repository Verified
