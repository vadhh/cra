# Legal Profile Evidence: Maintenance Contract

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/maintenance_contract.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A maintenance contract is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: maintenance contract, perjanjian pemeliharaan, contrat de maintenance
- **Draft Alias**: maintenance contract
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: maintenance contract, contrat de maintenance
- **Indonesian**: perjanjian pemeliharaan
...
- **How They Differ**: Maintenance Contract governs specific legal relations defined in maintenance_contract.json and registry_v1.json, distinct from generic terms in service_agreement.
...
- **Disambiguation Criteria**: This document is a maintenance contract for the ongoing upkeep or repair of equipment or property. (distinction from service_agreement).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Maintenance Contract (commercial_agreements)
- **Evidence Status**: Repository Verified
