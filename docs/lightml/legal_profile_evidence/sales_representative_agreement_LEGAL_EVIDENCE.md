# Legal Profile Evidence: Sales Representative Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/sales_representative_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A sales representative agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: sales representative agreement, sales agent agreement, perjanjian perwakilan penjualan
- **Draft Alias**: sales representative agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: sales representative agreement, sales agent agreement
- **Indonesian**: perjanjian perwakilan penjualan
...
- **Competing Profiles**: agency_agreement
...
- **How They Differ**: Sales Representative Agreement governs specific legal relations defined in sales_representative_agreement.json and registry_v1.json, distinct from generic terms in agency_agreement.
...
- **Disambiguation Criteria**: This document is a sales representative agreement in which a representative sells the principal's products, typically for commission. (distinction from agency_agreement).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Sales Representative Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
