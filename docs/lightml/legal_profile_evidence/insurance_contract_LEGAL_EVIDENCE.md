# Legal Profile Evidence: Insurance Contract / Policy

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/insurance_contract.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A insurance contract / policy is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: OJK regulations apply for ID.)
...
- **Verified Repository Alias**: insurance contract, insurance agreement, insurance policy, perjanjian asuransi, polis asuransi, contrat d'assurance
- **Draft Alias**: insurance contract / policy
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: insurance contract, insurance agreement, insurance policy, polis asuransi, contrat d'assurance
- **Indonesian**: perjanjian asuransi
...
- **How They Differ**: Insurance Contract / Policy governs specific legal relations defined in insurance_contract.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an insurance contract or policy under which an insurer agrees to cover specified risks in exchange for premiums. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, insurance, termination, dispute_resolution, payment_terms, limitation_liability, default_provisions, notice_period) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Insurance Contract / Policy (property_agreements)
- **Evidence Status**: Repository Verified
