# Legal Profile Evidence: Construction Contract

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/construction_contract.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A construction contract is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: UU 2/2017 Jasa Konstruksi applies for ID.)
...
### Clause: insurance
- **Clause**: insurance
- **Reason Mandatory**: Requires insurance coverage for operational risks.
- **Repository Source**: ldv-backend/detector/profiles/construction_contract.json
- **Legal Reference**: KUH Dagang Article Pasal 246 (ID)
- **Evidence Status**: Repository Verified
...
- **Evidence Status**: Repository Verified
### Clause Mapping: insurance
- **Law / Code**: KUH Dagang
- **Article**: Pasal 246
- **Official Citation / Note**: Pertanggungan risiko asuransi.
- **Repository Mapping**: Mapped to clause 'insurance' in ldv-backend/detector/detector_rules.py
- **Evidence Status**: Repository Verified
...
- **Verified Repository Alias**: construction contract, construction agreement, building contract, engineering contract, perjanjian konstruksi, kontrak konstruksi
- **Draft Alias**: construction contract
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: construction contract, construction agreement, building contract, engineering contract
- **Indonesian**: perjanjian konstruksi, kontrak konstruksi
...
- **How They Differ**: Construction Contract governs specific legal relations defined in construction_contract.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a construction contract for the design, building, or engineering of a physical structure. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, delivery_terms, warranty, termination, indemnification, dispute_resolution, insurance, limitation_liability) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Construction Contract (property_agreements)
- **Evidence Status**: Repository Verified
