# Legal Profile Evidence: Distribution Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/distribution_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A distribution agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: distribution agreement, distributor agreement, perjanjian distribusi, contrat de distribution
- **Draft Alias**: distribution agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: distribution agreement, distributor agreement, contrat de distribution
- **Indonesian**: perjanjian distribusi
...
- **How They Differ**: Distribution Agreement governs specific legal relations defined in distribution_agreement.json and registry_v1.json, distinct from generic terms in service_agreement.
...
- **Disambiguation Criteria**: This document is a distribution agreement in which a distributor resells the supplier's products within an assigned territory. (distinction from service_agreement).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Distribution Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
