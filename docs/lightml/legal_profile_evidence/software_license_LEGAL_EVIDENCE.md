# Legal Profile Evidence: Software License Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/software_license.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A software license agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: software license, software licence, software license agreement, eula, end user license agreement
- **Draft Alias**: software license agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: software license, software licence, software license agreement, eula, end user license agreement
- **Indonesian**: perjanjian software license agreement
...
- **Competing Profiles**: saas_agreement, licensing_agreement
...
- **How They Differ**: Software License Agreement governs specific legal relations defined in software_license.json and registry_v1.json, distinct from generic terms in saas_agreement, licensing_agreement.
...
- **Disambiguation Criteria**: This document grants a license to use software between licensor and licensee. (distinction from saas_agreement, licensing_agreement).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, license_grant, ip_ownership, limitation_liability, warranty_disclaimer, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Software License Agreement (baseline_agreements)
- **Evidence Status**: Repository Verified
