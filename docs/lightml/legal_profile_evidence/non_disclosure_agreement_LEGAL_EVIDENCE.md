# Legal Profile Evidence: Non-Disclosure Agreement

## 1. Contract Definition
- **Formal Legal Definition**: Standard Non-Disclosure Agreement profile mapping required clauses.
- **Repository Source**: [profiles/non_disclosure_agreement.json](file:///mnt/c/Users/ADVAN/cra/ldv-backend/detector/profiles/non_disclosure_agreement.json)
...
- **Repository Evidence**: Listed in profiles/non_disclosure_agreement.json required_clauses
...
- **Why Mandatory**: Requires return or destruction of confidential materials upon termination.
- **Repository Evidence**: Listed in profiles/non_disclosure_agreement.json required_clauses
- **Legal Reference**: general law Art. Return of materials, French Code civil Art. Art. 1134, KUHPerdata Art. Pasal 1338
- **Evidence Status**: Verified
...
- **Reason**: Supported jurisdiction for contract analysis profile 'Non-Disclosure Agreement'.
- **Repository Source**: profiles/non_disclosure_agreement.json coverage.jurisdictions
...
- **Law / Code**: general law
- **Article**: Return of materials
- **Official Citation / Note**: NDA property return/destruction obligations are standard
- **Repository Mapping**: Mapped to clause 'return_of_materials' in detector_rules.py
- **Evidence Status**: Verified
...
## 7. Aliases
- **Verified Aliases**: non-disclosure agreement, NDA, confidentiality agreement, geheimhouding
- **Repository Aliases**: confidentiality agreement, perjanjian kerahasiaan, accord de confidentialité, geheimhouding, nda, geheimhoudingsovereenkomst, NDA, non-disclosure agreement
- **Draft Aliases**: nda, perjanjian kerahasiaan, accord de confidentialité, geheimhoudingsovereenkomst
- **Unsupported Aliases**: Evidence Not Found

### Language Breakdown
- **English**: confidentiality agreement, geheimhouding, nda, NDA, non-disclosure agreement
...
- **Why They Compete**: NDAs contain basic covenants that are often found in general contract boilerplates.
- **How They Differ**: Non-disclosure agreement is dedicated entirely to protecting proprietary information and trade secrets, whereas general contracts contain confidentiality as a secondary term.
- **Classifier Distinction Strategy**: Verify return of materials and strict confidentiality terms as the primary object.

## 9. Disambiguation Criteria
- **Disambiguation Criteria**: Non-disclosure agreement is dedicated entirely to protecting proprietary information and trade secrets, whereas general contracts contain confidentiality as a secondary term. (commercial and legal separation from competing profiles: general_contract).
