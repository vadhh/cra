# Legal Profile Evidence: Event Contract

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/event_contract.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A event contract is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: event contract, event services agreement, perjanjian acara, perjanjian event
- **Draft Alias**: event contract
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: event contract, event services agreement
- **Indonesian**: perjanjian acara, perjanjian event
...
- **How They Differ**: Event Contract governs specific legal relations defined in event_contract.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an event contract for the planning, staging, or provision of services at an event. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, force_majeure, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Event Contract (commercial_agreements)
- **Evidence Status**: Repository Verified
