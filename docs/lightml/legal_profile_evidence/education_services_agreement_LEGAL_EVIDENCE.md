# Legal Profile Evidence: Education Services Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/education_services_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A education services agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: education services agreement, training agreement, perjanjian pendidikan, perjanjian pelatihan
- **Draft Alias**: education services agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: education services agreement, training agreement
- **Indonesian**: perjanjian pendidikan, perjanjian pelatihan
...
- **How They Differ**: Education Services Agreement governs specific legal relations defined in education_services_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an education or training services agreement for the provision of instruction or educational programs. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Education Services Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
