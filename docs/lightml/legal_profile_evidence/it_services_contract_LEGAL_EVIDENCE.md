# Legal Profile Evidence: IT Services Contract

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/it_services_contract.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A it services contract is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: it services contract, it service agreement, it services agreement, technology services agreement, managed services agreement, perjanjian layanan it
- **Draft Alias**: it services contract
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: it services contract, it service agreement, it services agreement, technology services agreement, managed services agreement
- **Indonesian**: perjanjian layanan it
...
- **How They Differ**: IT Services Contract governs specific legal relations defined in it_services_contract.json and registry_v1.json, distinct from generic terms in service_agreement.
...
- **Disambiguation Criteria**: This document is an IT services contract for the provision of information technology support or managed services. (distinction from service_agreement).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, ip_ownership, limitation_liability, warranty_disclaimer, termination, dispute_resolution, confidentiality) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for IT Services Contract (commercial_agreements)
- **Evidence Status**: Repository Verified
