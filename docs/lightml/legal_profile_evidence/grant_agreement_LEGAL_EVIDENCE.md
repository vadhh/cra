# Legal Profile Evidence: Grant Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/grant_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A grant agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: grant agreement, perjanjian hibah, convention de subvention
- **Draft Alias**: grant agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: grant agreement, convention de subvention
- **Indonesian**: perjanjian hibah
...
- **How They Differ**: Grant Agreement governs specific legal relations defined in grant_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a grant agreement under which funds are given to a recipient for a specified purpose without repayment. (distinction from general_contract).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Grant Agreement (corporate_agreements)
- **Evidence Status**: Repository Verified
