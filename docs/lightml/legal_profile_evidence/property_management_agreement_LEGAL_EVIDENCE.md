# Legal Profile Evidence: Property Management Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/property_management_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A property management agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: property management agreement, perjanjian manajemen properti
- **Draft Alias**: property management agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: property management agreement
- **Indonesian**: perjanjian manajemen properti
...
- **How They Differ**: Property Management Agreement governs specific legal relations defined in property_management_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a property management agreement appointing a manager to operate and maintain real property on the owner's behalf. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, compensation, termination, indemnification, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Property Management Agreement (property_agreements)
- **Evidence Status**: Repository Verified
