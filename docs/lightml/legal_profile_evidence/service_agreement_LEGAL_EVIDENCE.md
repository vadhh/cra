# Legal Profile Evidence: Service Agreement

## 1. Contract Definition
- **Formal Legal Definition**: Standard Service Agreement profile mapping required clauses.
- **Repository Source**: [profiles/service_agreement.json](file:///mnt/c/Users/ADVAN/cra/ldv-backend/detector/profiles/service_agreement.json)
...
- **Repository Evidence**: Listed in profiles/service_agreement.json required_clauses
...
- **Why Mandatory**: Caps financial liability to manage commercial risk.
- **Repository Evidence**: Listed in profiles/service_agreement.json required_clauses
- **Legal Reference**: KUH Perdata (Indonesian Civil Code) Art. Pasal 1243, Pasal 1365
- **Evidence Status**: Verified
...
- **Reason**: Supported jurisdiction for contract analysis profile 'Service Agreement'.
- **Repository Source**: profiles/service_agreement.json coverage.jurisdictions
...
- **Repository Mapping**: Mapped to clause 'limitation_liability' in detector_rules.py
- **Evidence Status**: Verified
...
## 7. Aliases
- **Verified Aliases**: service agreement, services agreement, master services agreement, MSA
- **Repository Aliases**: service agreement, services agreement, service contract, dienstverleningsovereenkomst, perjanjian jasa, MSA, maintenance agreement, master services agreement, contrat de services
- **Draft Aliases**: service contract, maintenance agreement, perjanjian jasa, contrat de services, dienstverleningsovereenkomst
- **Unsupported Aliases**: Evidence Not Found

### Language Breakdown
- **English**: service agreement, services agreement, service contract, MSA, maintenance agreement, master services agreement
- **Indonesian**: perjanjian jasa
- **French**: contrat de services
- **Dutch**: dienstverleningsovereenkomst

## 8. Competing Contract Types
- **Competing Profiles**: consulting_agreement, employment_contract, it_services_contract, general_contract
- **Why They Compete**: All govern the performance of tasks or services in exchange for compensation.
- **How They Differ**: Service agreement is B2B for general tasks, consulting is for professional advisory, IT service is for technical systems, and employment involves direct master-servant subordination.
- **Classifier Distinction Strategy**: Look for specific scope of services, provider/client roles, and absence of employment subordination markers.

## 9. Disambiguation Criteria
- **Disambiguation Criteria**: Service agreement is B2B for general tasks, consulting is for professional advisory, IT service is for technical systems, and employment involves direct master-servant subordination. (commercial and legal separation from competing profiles: consulting_agreement, employment_contract, it_services_contract, general_contract).
