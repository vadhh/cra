...
- **Repository Source**: ldv-backend/detector/profiles/service_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A service agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: service agreement, service contract, maintenance agreement, perjanjian jasa, contrat de services, dienstverleningsovereenkomst
- **Draft Alias**: service agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: service agreement, service contract, maintenance agreement, contrat de services, dienstverleningsovereenkomst
...
- **Competing Profiles**: maintenance_contract, outsourcing_agreement, it_services_contract, distribution_agreement, agency_agreement
...
- **How They Differ**: Service Agreement governs specific legal relations defined in service_agreement.json and registry_v1.json, distinct from generic terms in maintenance_contract, outsourcing_agreement, it_services_contract, distribution_agreement, agency_agreement.
...
- **Disambiguation Criteria**: This document covers the provision of services. (distinction from maintenance_contract, outsourcing_agreement, it_services_contract, distribution_agreement, agency_agreement).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, termination, limitation_liability, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Service Agreement (commercial_agreements)
- **Evidence Status**: Repository Verified
