# Legal Profile Evidence: Energy Supply Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/energy_supply_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A energy supply agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
- **Comments**: Engineering implementation verified with active JSON schema. Repository evidence compiled. Differentiated legal citation review performed by Legal Counsel. (Notes: PLN/ESDM regulations apply for ID.)
...
- **Clause**: force_majeure
- **Reason Mandatory**: Excuses performance failure due to catastrophic events.
- **Repository Source**: ldv-backend/detector/profiles/energy_supply_agreement.json
- **Legal Reference**: KUH Perdata (Indonesian Civil Code) Article Pasal 1244, Pasal 1245 (ID)
- **Evidence Status**: Repository Verified
### Clause: termination
- **Clause**: termination
...
- **Evidence Status**: Repository Verified
### Clause Mapping: force_majeure
- **Law / Code**: KUH Perdata (Indonesian Civil Code)
- **Article**: Pasal 1244, Pasal 1245
- **Official Citation / Note**: Keadaan memaksa yang membebaskan ganti rugi.
- **Repository Mapping**: Mapped to clause 'force_majeure' in ldv-backend/detector/detector_rules.py
- **Evidence Status**: Repository Verified
...
- **Verified Repository Alias**: energy supply agreement, power purchase agreement, ppa, perjanjian jual beli listrik, perjanjian pasokan energi
- **Draft Alias**: energy supply agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: energy supply agreement, power purchase agreement, ppa
- **Indonesian**: perjanjian jual beli listrik, perjanjian pasokan energi
...
- **How They Differ**: Energy Supply Agreement governs specific legal relations defined in energy_supply_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is an energy supply agreement for the delivery of electricity, power, or other energy resources. (distinction from general_contract).
...
- **Recommendation**: Ensure all required clauses (governing_law, jurisdiction_venue, scope_of_services, payment_terms, delivery_terms, force_majeure, termination, dispute_resolution) are explicitly incorporated to maintain full statutory compliance.
- **Evidence Status**: Repository Verified
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Energy Supply Agreement (corporate_agreements)
- **Evidence Status**: Repository Verified
