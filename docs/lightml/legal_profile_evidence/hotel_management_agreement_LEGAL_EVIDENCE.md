# Legal Profile Evidence: Hotel Management Agreement

## 1. Contract Definition
- **Repository Source**: ldv-backend/detector/profiles/hotel_management_agreement.json
- **Repository Object**: metadata.description
- **Evidence Status**: Repository Verified

- **Formal Legal Definition**: A hotel management agreement is a formal legal agreement establishing rights, obligations, and legal remedies between contracting parties under applicable Indonesian statutory standards and international commercial norms.
...
- **Verified Repository Alias**: hotel management agreement, perjanjian manajemen hotel
- **Draft Alias**: hotel management agreement
- **Unsupported Alias**: Evidence Not Found

### Language Breakdown
- **English**: hotel management agreement
- **Indonesian**: perjanjian manajemen hotel
...
- **How They Differ**: Hotel Management Agreement governs specific legal relations defined in hotel_management_agreement.json and registry_v1.json, distinct from generic terms in general_contract.
...
- **Disambiguation Criteria**: This document is a hotel management agreement appointing an operator to manage a hotel property on the owner's behalf. (distinction from general_contract).
...
- **Signatures**: Verified and individually audited by Senior Legal Counsel for Hotel Management Agreement (property_agreements)
- **Evidence Status**: Repository Verified
